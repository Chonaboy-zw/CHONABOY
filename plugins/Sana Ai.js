...
if (conf.LANG == 'ML') {
    ...
    already_off = '♡︎..ᴄʜᴏɴᴀ ʙᴏʏ..♡︎ നിലവിൽ സെമി-ഫംഗ്ഷണൽ ആണ്.'
...
Asena.addCommand({ pattern: 'sana ?(.*)', desc: fulleva_dsc, fromMe: true,dontAddCommandList: true, usage: '.chona on / off' }, (async (message, match) => {
